    ...
    <section className="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="section-padding relative z-10 w-full text-white">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-white/80 mb-10 leading-relaxed font-light font-sans max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            <motion.button
              ...
              onClick={onExplore}
              className="btn-premium group flex items-center gap-2 bg-brand-accent text-brand-dark hover:bg-white"
            >
              Explore Menu
            ...
            <motion.button 
              ...
              className="flex items-center gap-3 px-6 py-3 text-sm font-medium tracking-widest uppercase hover:text-brand-accent transition-colors duration-700"
            >
