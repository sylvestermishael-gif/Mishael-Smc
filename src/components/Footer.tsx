    ...
    <footer id="contact" className="bg-brand-dark text-white pt-24 pb-12">
      <div className="section-padding grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-white/10 pb-16 mb-12">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-sm font-light">
            <div className="flex justify-between border-b border-white/5 pb-2">
              <span className="text-white/50 lowercase italic">Mon - Thu</span>
              <span>12:00 PM - 10:00 PM</span>
            </div>
            <div className="flex justify-between border-b border-white/5 pb-2">
              <span className="text-white/50 lowercase italic">Fri - Sat</span>
        ...
        <div className="space-y-6 lg:pl-12">
          <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] text-brand-accent mb-8 block">Find Us</h4>
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-sm font-light text-white/70">+234 812 345 6789</p>
            </div>
            <div className="flex items-center gap-4">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-2">
            <input 
              ...
              className="bg-white/5 border border-white/10 px-4 py-3 text-sm focus:outline-none focus:border-brand-accent transition-colors"
            />
            <button className="bg-brand-accent text-brand-dark py-3 text-[10px] font-bold uppercase tracking-widest hover:bg-white transition-colors">
              Subscribe
            </button>
          </div>
        </div>
